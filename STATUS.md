# 20-assistme -- Implementation Status

**Last Updated**: 2026-03-03 by agent:copilot
**Data Model**: GET http://localhost:8010/model/projects/20-assistme
...
# Project facts
Invoke-RestMethod "$base/model/projects/20-assistme" | Select-Object id, maturity, phase, pbi_total, pbi_done
...
For veritas audit:
```
MCP tool: audit_repo  repo_path=C:\eva-foundry\20-assistme
MCP tool: get_trust_score  repo_path=C:\eva-foundry\20-assistme
```
...
**Data model record**: http://localhost:8010/model/projects/20-assistme
...
1. Run veritas audit: `audit_repo` MCP tool, repo_path = C:\eva-foundry\20-assistme
2. Check data model record: GET /model/projects/20-assistme
3. Update PLAN.md with actual sprint stories
4. Fill ACCEPTANCE.md gate table with project-specific criteria
5. Commit first evidence: PUT /model/projects/20-assistme with updated notes
